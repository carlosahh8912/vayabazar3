<div>
                ...
                <div class="card-body p-12">
                    ...
                    <div class="d-flex flex-column align-items-start flex-xxl-row">
                        ...
                        <div class="d-flex align-items-center flex-equal fw-row me-4 order-2" data-bs-toggle="tooltip"
                            data-bs-trigger="hover" title="" data-bs-original-title="Fecha de venta">
                            <!--begin::Date-->
                            <div class="fs-6 fw-bolder text-gray-700 text-nowrap">Fecha: {{ date('d, M Y') }}</div>
                            <!--end::Date-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        ...
                        <div class="order-3 my-sm-2">
                            <button onclick="clearCart()" class="btn btn-active-light-danger btn-active-icon-danger">
                    ...
                    <div class="mb-0">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div wire:ignore class="mb-5">
                                    <select class="form-control form-control-solid" name="customer_id" id="customer_id"
                                        data-control="select2" data-placeholder="Seleccione un cliente">
                                        <option></option>
                                ...
                                <div class="mb-5">
                                    <input wire:model="customer_email" type="email"
                                        class="form-control form-control-solid" placeholder="Correo" readonly disabled>
                                </div>
                                <!--end::Input group-->
                            </div>
                            <!--end::Col-->
                        ...
                        <div class="row gx-10 mb-5 justify-content-center">
                            ...
                            @foreach ($products as $product)
                                <x-product-card :id="$product->id" :title="$product->description" :cost="$product->cost"
                        ...
                        <div class="table-responsive mb-10">
                            <!--begin::Table-->
                            <table class="table table-striped g-5 gs-0 mb-0 fw-bolder text-gray-700">
                                <!--begin::Table head-->
                                <thead>
                                    <tr class="border-bottom fs-7 fw-bolder text-gray-700 text-uppercase">
                                        <th class="min-w-300px w-475px">Prenda</th>
                                        <th class="min-w-100px w-100px">Cantidad</th>
                                        <th class="min-w-150px w-150px text-end">Precio</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button onclick="removeItem({{ $item->id }})"
                                                        ...
                                                        <i class="las la-trash-alt fs-2 text-danger"></i>
                                                    </button>
                                                </td>
                                            </tr>
                                        @endforeach
                        ...
                        <div class="mb-0">
                            ...
                            <textarea wire:model="notes" name="notes" class="form-control form-control-solid" rows="3"
                ...
                <div class="card-body p-10">
                    ...
                    <div class="mb-10">
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="form-label fs-2">Items </div>
                            <div class="fs-2">{{ $total_items }}</div>
                        </div>
                        <div class="d-flex justify-content-between">
                            <div class="form-label fs-2">Costo </div>
                            <div class="fs-2">$ {{ $total_cost }}</div>
                        </div>
                        <div class="d-flex justify-content-between">
                            <div class="form-label fs-2x">Total </div>
                            <div class="fs-2x">$ {{ number_format($total, 2) }}</div>
                        </div>
                    </div>
                    <!--end::Input group-->
                    <!--begin::Separator-->
                    ...
                    <div class="mb-0">
                        ...
                        @if ($total > 0)
                            ...
                            <button onclick="saveSale()" class="btn btn-info w-100">
    ...
    @push('scripts')
        <script>
            ...
            function clearCart() {
                Swal.fire({
                    html: `¿Seguro que quieres <span class="badge badge-danger">Vaciar</span> todo el carrito?`,
                    icon: "warning",
                    buttonsStyling: false,
                    showCancelButton: true,
                    confirmButtonText: "Ok, Vaciar",
                    ...
                    if (response.isConfirmed) {
                        window.livewire.emit('clear_cart');
                    }
                });
            };
            ...
            function removeItem(id) {
                Swal.fire({
                    html: `¿Seguro que quieres <span class="badge badge-danger">Quitar</span> este producto del carrito?`,
                    icon: "question",
                    buttonsStyling: false,
                    showCancelButton: true,
                    confirmButtonText: "Ok, Quitar",
                    cancelButtonText: 'No, Cancelar',
                    customClass: {
                        confirmButton: "btn btn-danger",
                        cancelButton: 'btn btn-secondary'
                    ...
                    if (response.isConfirmed) {
                        window.livewire.emit('remove_item', id);
                    }
                });
            };
            ...
            function saveSale() {
                Swal.fire({
                    html: `¿Seguro que quieres <span class="badge badge-info">Guardar</span> esta venta?`,
                    icon: "info",
                    buttonsStyling: false,
                    showCancelButton: true,
                    ...
                    if (response.isConfirmed) {
                        window.livewire.emit('save_sale');
                    }
                });
            };
        </script>
