<div>
    <div>
        ...
        <x-slot name="title">Lista de Paqueterias</x-slot>
        <x-slot name="page">Paqueterias</x-slot>
        ...
        <x-card-body>
            ...
            <x-slot name="toolbar">
                <x-modal-button>Nueva Paqueteria</x-modal-button>
            </x-slot>
            ...
            <x-table :titles="['ID','Paqueteria','Acciones']">
                @foreach ($shippings as $shipping)
                    ...
                    <tr>
                        ...
                        <td class="">
                            <a href="#" class="text-gray-800 text-hover-primary mb-1">{{ $shipping->name }}</a>
                        </td>
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <button wire:click="show({{ $shipping->id }})"
                            ...
                            <button
                                ...
                                title="Eliminar" onclick="deleted({{ $shipping->id }})">
        ...
        <x-modal-form title="{{ empty($shipping_id) ? 'NUEVO CLIENTE' : 'ACTUALIZAR CLIENTE' }}" id="formModal">
            ...
            <x-slot name="footer">
                <div class="d-flex justify-content-end">
                    ...
                    @if (empty($shipping_id) || $shipping_id == 0 || $shipping_id == '')
