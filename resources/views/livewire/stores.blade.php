<div>
    <div>
        ...
        <x-slot name="title">Lista de Tiendas</x-slot>
        <x-slot name="page">Tiendas</x-slot>
        ...
        <x-card-body>
            ...
            <x-slot name="toolbar">
                <x-modal-button>Nueva Tienda</x-modal-button>
            </x-slot>

            <x-table :titles="['ID','Tienda','Acciones']">
                @foreach ($stores as $store)
                    ...
                    <tr>
                        ...
                        <td class="">
                            <a href="#" class="text-gray-800 text-hover-primary mb-1">{{ $store->name }}</a>
                        </td>
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <button wire:click="show({{ $store->id }})"
                            ...
                            <button
                                ...
                                title="Eliminar" onclick="deleted({{ $store->id }})">
        ...
        <x-modal-form title="{{ empty($store_id) ? 'NUEVO CLIENTE' : 'ACTUALIZAR CLIENTE' }}" id="formModal">
            ...
            <x-slot name="footer">
                <div class="d-flex justify-content-end">
                    ...
                    @if (empty($store_id) || $store_id == 0 || $store_id == '')
