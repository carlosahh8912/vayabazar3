<div>
    <div>
        ...
        <x-slot name="page">Clientes</x-slot>
        ...
        <x-card-body>
            ...
            <x-slot name="toolbar">
                <x-modal-button>Nuevo Cliente</x-modal-button>
            </x-slot>

            <x-table :titles="['ID','Cliente','Compras', 'Estatus', 'Acciones']">
                @foreach ($customers as $customer)
                    ...
                    <tr class="">
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <button wire:click="show({{ $customer->id }})"
                            ...
                            @if ($customer->sales->count() <= 0)
                                <button
                                    ...
                                    title="Eliminar" onclick="deleted({{ $customer->id }})">
        ...
        <x-modal-form title="{{ empty($customer_id) ? 'NUEVO CLIENTE' : 'ACTUALIZAR CLIENTE' }}" id="formModal">
            ...
            <x-slot name="content">
                ...
                <div class="mb-5">
                    ...
                    <input wire:model.lazy="address" name="address" type="text"
                        class="form-control form-control-solid  {{ $errors->has('address') ? 'is-invalid' : '' }}"
                ...
                <div class="mb-5">
                    ...
                    <input wire:model.lazy="email" name="email" id="email" type="email"
                ...
                <div class="mb-5">
                    ...
                    <input wire:model.lazy="phone" name="phone" id="phone" type="number"
            ...
            <x-slot name="footer">
                <div class="d-flex justify-content-end">
                    ...
                    @if (empty($customer_id) || $customer_id == 0 || $customer_id == '')
        ...
        @push('scripts')
            ...
            <script>
                ...
                function deleted(id) {
                    ...
                    Swal.fire({
                        html: `¿Seguro que quieres <span class="badge badge-danger">Eliminar</span> este Cliente?`,
                        icon: "question",
